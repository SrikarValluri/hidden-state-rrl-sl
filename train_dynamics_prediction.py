...
state_labels_train = state_labels[0:40000][:,1] 

state_vector_test = state_vector[40000:50000]
state_labels_test = state_labels[40000:50000][:,1]
...
for epoch in range(200):
    ...
    pickle.dump(model, open("./trained_models_sl/COM_Adam_10epoch_1e-4lr_500000:250000_randomized.p", "wb"))

model = pickle.load(open("./trained_models_sl/COM_Adam_10epoch_1e-4lr_500000:250000_randomized.p", "rb"))
model.eval()
...
for data in range(0, 1000):
    ...
    print("Predicted: ", predict[data], "Actual: ", state_labels_test[data], "difference: ", np.abs(predict[data][0] - state_labels_test[data]))
